...
public class MjnvBlockInit {
    ...
    public static void registerJukeboxNoteblockBlocks() {
        ...
        MORE_JUKEBOX_VARIANT_BLOCK_ENTITY = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, MoreJukeboxNoteblockVariants.asId("more_smoker_variant"), BlockEntityType.Builder.of(MoreJukeboxVariantBlockEntity::new, more_jukeboxes.toArray(Block[]::new)).build());

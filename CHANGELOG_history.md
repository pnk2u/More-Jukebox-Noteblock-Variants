...
<a name="1.2.2"></a>
### 1.2.2:
- `1.21.5(-9)`: Fix incorrectly requiring <ins>1.21.9</ins> instead of <ins>1.21.5</ins>

  
---
<a name="1.2.1"></a>
### 1.2.1:
- `1.21.5(-9)`: Update to <ins>1.21.9</ins>
...
<a name="1.0.3"></a>
### 1.0.3:
- Fix _Jukeboxes_ dropping as _Noteblocks_ when mined
...
- `1.21.2(3)`: Update to <ins>1.21.2</ins>, <ins>1.21.3</ins>
